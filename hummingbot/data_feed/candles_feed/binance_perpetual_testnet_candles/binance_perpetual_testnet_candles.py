...
from hummingbot.data_feed.candles_feed.binance_perpetual_testnet_candles import constants as CONSTANTS
from hummingbot.data_feed.candles_feed.candles_base import CandlesBase
from hummingbot.logger import HummingbotLogger


class BinancePerpetualTestnetCandles(CandlesBase):
